...
CREATE TABLE IF NOT EXISTS members (
    ...
    country VARCHAR(100) NULL DEFAULT 'België',
    notes TEXT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS memberships (
    ...
    ends_at DATE NULL,
    paid_at DATE NULL,
    annual_flight_entitlement SMALLINT UNSIGNED NOT NULL DEFAULT 1,
    annual_flights_used SMALLINT UNSIGNED NOT NULL DEFAULT 0,
    notes TEXT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
