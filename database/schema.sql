...
CREATE TABLE IF NOT EXISTS members (
    ...
    member_type ENUM('viewer','flyer','pilot') NOT NULL DEFAULT 'viewer',
...
CREATE TABLE IF NOT EXISTS memberships (
    ...
    membership_type ENUM('viewer','flyer','pilot') NOT NULL DEFAULT 'viewer',
    payment_status ENUM('unpaid','paid') NOT NULL DEFAULT 'unpaid',
    paid_at DATE NULL,
    free_flight_entitled TINYINT(1) NOT NULL DEFAULT 0,
